      ...
      <section className="py-20 lg:py-28 section-pattern">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto mt-12">
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-heliaxis-gold">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-heliaxis-gold/10 rounded-xl p-8">
                <h3 className="text-xl font-bold text-heliaxis-navy mb-6 flex items-center gap-2">
            ...
            <div className="mt-8 bg-heliaxis-navy rounded-xl p-6 text-white">
              <div className="flex items-start gap-4">
                <AlertCircle className="w-6 h-6 text-heliaxis-gold flex-shrink-0 mt-1" />
                <div>
            ...
            <div>
              <Card className="bg-white border-none shadow-xl">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-heliaxis-gold/10 rounded-lg">
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 bg-heliaxis-gold/10 rounded-xl p-6 border border-heliaxis-gold/20">
              <div className="flex items-start gap-4">
