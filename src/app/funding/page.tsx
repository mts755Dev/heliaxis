        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              {/* Image */}
              <div className="aspect-[16/9] rounded-xl overflow-hidden relative mb-8 lg:hidden">
                <Image
            ...
            <div className="space-y-6">
              {/* Desktop Image */}
              <div className="aspect-[16/9] rounded-xl overflow-hidden relative hidden lg:block">
                <Image
                  src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=450&fit=crop"
                  alt="Funding documentation and project planning"
                  fill
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <div className="bg-heliaxis-gold/5 rounded-xl p-6 border border-heliaxis-gold/20">
